...
COUNTRY_CODE = {
    "Guatemala": "GT", "Colombia": "CO", "Panama": "PA",
...
CLIENTS_PER_COUNTRY = {
    "Guatemala": 14, "Colombia": 14, "Panama": 11, "Bolivia": 11, "Paraguay": 10,
}
CREDIT_TERMS_DAYS = [30, 45, 60]

# --- LLM --------------------------------------------------------------------
MODEL_ID = "claude-opus-4-8"        # NOTE: temperature/top_p are rejected (400) on this model
PING_MODEL_ID = "claude-haiku-4-5"  # cheap preflight connectivity check
MAX_TOKENS = 8000
...
SEVERITY = {
    ...
    "A5": "medium", "A6": "medium", "A7": "high", "A8": "high", "A9": "medium",
}
